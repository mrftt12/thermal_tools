...
export function DashboardScreen({ navigation }: { navigation: any }) {
  ...
  return (
    <ScrollView style={styles.page} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subTitle}>Guest workspace with project calculations + AI expert guidance</Text>
      ...
      <View style={styles.actionsCard}>
        ...
        <Pressable style={styles.secondaryAction} onPress={() => navigation.navigate('AI')}>
          <Text style={styles.secondaryActionText}>Ask AI Thermal Expert</Text>
        </Pressable>
      ...
      <View style={styles.recentCard}>
        ...
        {stats?.recent_projects?.length ? (
          ...
          <Text style={styles.emptyText}>No projects yet. Create one from the Projects tab.</Text>
        )}
      </View>
    </ScrollView>
  );
